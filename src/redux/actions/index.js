...
const options1 = {
  ...
  headers: {
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2YzM2EzZDgzODFmYzAwMTNmZmZhZDYiLCJpYXQiOjE2NzkwNzI5NDgsImV4cCI6MTY4MDI4MjU0OH0.RX3q6k3_yCHRNDH9sl76zbRHZ8nxK9qrkC9ep2yeW6M",
  },
  // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2YzM2EzZDgzODFmYzAwMTNmZmZhZDYiLCJpYXQiOjE2NzkwNzI5NDgsImV4cCI6MTY4MDI4MjU0OH0.RX3q6k3_yCHRNDH9sl76zbRHZ8nxK9qrkC9ep2yeW6M
};
...
export const changeTitle = (userId, title) => {
  return async (dispatch) => {
    const res = await fetch(`${process.env.REACT_APP_BE_URL}/users/${userId}`, {
      method: "PUT",
      headers: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2YzM2EzZDgzODFmYzAwMTNmZmZhZDYiLCJpYXQiOjE2NzkwNzI5NDgsImV4cCI6MTY4MDI4MjU0OH0.RX3q6k3_yCHRNDH9sl76zbRHZ8nxK9qrkC9ep2yeW6M",
